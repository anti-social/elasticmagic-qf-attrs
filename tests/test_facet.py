...
def test_attr_int_simple_filter__unknown_param(int_qf, compiler):
...
def test_attr_int_simple_filter__existing_post_filter(int_qf, compiler):
    sq = int_qf.apply(
...
def test_attr_int_simple_filter__empty_params(int_qf, compiler):
...
def test_attr_int_simple_filter__single_selected_value(int_qf, compiler):
    params = {'a18': '58084'}
...
def test_attr_int_simple_filter__multiple_selected_values(int_qf, compiler):
    sq = int_qf.apply(
        SearchQuery(),
