...
async def test_int_attrs_empty(es_index, products):
    ...
    manufacturer_facet = qf_res.attrs.get_attr_facet(Manufacturer.attr_id)
    ...
    country_facet = qf_res.attrs.get_attr_facet(Country.attr_id)
...
#     qf = IntAttrsQueryFilter()
#
#     sq = qf.apply(es_index.search_query(), {'a2': '1', 'a1': ['1', '3']})
#     qf_res = qf.process_result(await sq.get_result())
#
#     manufacturer_facet = qf_res.attrs.get_attr_facet(Manufacturer.attr_id)
#     assert len(manufacturer_facet.all_values) == 2
